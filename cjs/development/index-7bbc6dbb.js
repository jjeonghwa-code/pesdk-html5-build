...
var Items$9 = function (_a) {
    ...
    var renderTransform = function (option, index) {
        return option ? (React__default.createElement(BasicUIComponents.Card, { key: option.identifier, onClick: function () { return transformTool.changeIdentifier(option.identifier); }, image: option.thumbnailURI, style: { animationDelay: index * 0.08 + "s", backgroundSize: '50%' }, isActive: option.identifier === transformTool.identifier, label: option.name },
            React__default.createElement(BasicUIComponents.CardLabel, null, option.name))) : (React__default.createElement(BasicUIComponents.ItemsSeparator, { key: "transform" + index }));
    };
    return React__default.createElement(BasicUIComponents.CardContainer, null, transformTool.items.map(renderTransform));
};
var TransfromItemsBar = index.inject('transformTool')(index.observer(Items$9));
...
var FileInput = styled__default.input.attrs({
    ...
    accept: 'image/*',
    multiple: true,
})(templateObject_1$p || (templateObject_1$p = index.__makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), index.States.VisuallyHidden);
...
var AlignmentButton = styled__default(BasicUIComponents.Button.TextSecondary)(templateObject_1$q || (templateObject_1$q = index.__makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (props) { return props.theme.textInput.foreground; });
var Text = styled__default(index.Components.Input.NummericInput)(templateObject_2$8 || (templateObject_2$8 = index.__makeTemplateObject(["\n  max-width: 55px;\n  > div > input {\n    text-align: center;\n  }\n"], ["\n  max-width: 55px;\n  > div > input {\n    text-align: center;\n  }\n"])));
