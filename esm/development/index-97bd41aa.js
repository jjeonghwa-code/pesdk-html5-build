import { n as FocusIdentifier, J as Vector2, K as uuid, T as Tool, _ as __assign, I as ImageFormat } from './index-1287cbee.js';
import 'react';
import 'react-dom';
        ...
        if (typeof state !== 'string') {
            ...
            if (state.assetLibrary) {
                ...
                appState_1.customStickers = appState_1.customStickers.map(function (c) {
                    ...
                    return __assign({}, c, { raster: __assign({}, c.raster, { data: Data64(c.raster.type) + img }) });
                });
            }
            return appState_1;
        }
