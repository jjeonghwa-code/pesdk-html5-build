...
var Items$9 = /** @class */ (function (_super) {
    ...
    Items.prototype.componentDidMount = function () {
        this.simpleBar = new SimpleBar(document.getElementById('TransformConfig'), { autoHide: false });
    };
    Items.prototype.render = function () {
        var transformTool = this.props.transformTool;
        var categories = transformTool.entities;
        return (React.createElement(BasicUIComponents.DynamicCardContainer, { id: "TransformConfig" },
            React.createElement("div", null, categories && categories.length ? this.renderCategories(categories) : null)));
    };
    return Items;
}(React.Component));
var TransfromItemsBar = inject('transformTool', 'config')(observer(Items$9));
...
var AlignmentButton = styled(BasicUIComponents.Button.TextSecondary)(templateObject_1$r || (templateObject_1$r = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (props) { return props.theme.textInput.foreground; });
var Text = styled(Components.Input.NummericInput)(templateObject_2$9 || (templateObject_2$9 = __makeTemplateObject(["\n  max-width: 55px;\n  > div > input {\n    text-align: center;\n  }\n"], ["\n  max-width: 55px;\n  > div > input {\n    text-align: center;\n  }\n"])));
